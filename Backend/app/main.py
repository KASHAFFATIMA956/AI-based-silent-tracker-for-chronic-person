...
review), admin (People & roles management), messages (direct messaging
between a patient/attendant and their assigned doctor, added 2026-09-07).
This is the full backend scope for the hackathon MVP — see
context/progress.md.
"""
...
from app.routers import admin, auth, doctors, entries, messages, patients
