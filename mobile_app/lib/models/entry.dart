...
class Entry {
  ...
  factory Entry.fromJson(Map<String, dynamic> json) => Entry(
        ...
        bloodSugarMgDl: (json['blood_sugar_mg_dl'] as num?)?.toInt(),
  ...
  // Added 2026-09-07 — optional home-monitoring readings, mirrors
  // weight_value's contract exactly (nullable, not entry_type-gated).
  // Persisted/displayed only — NOT yet part of risk_result scoring, see
