                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      // context/api-contracts.md. Shown whenever present,
                      // same "only if the patient logged one" convention
                      // as every other optional metric above.
                      if (entry.systolicBp != null && entry.diastolicBp != null)
                        Text('BP ${entry.systolicBp}/${entry.diastolicBp}', style: _metaStyle(context)),
                      if (entry.bloodSugarMgDl != null)
                        Text('Sugar ${entry.bloodSugarMgDl} mg/dL', style: _metaStyle(context)),
