...
import { DoctorPatientMessagesScreen } from './screens/doctor/PatientMessagesScreen'
...
export default function App() {
  ...
  const { loadAll, reset, profile } = usePatientData()
    ...
    return (
      <Routes>
        <Route element={<DoctorShell />}>
          ...
          <Route path="/roster/:patientId/messages" element={<DoctorPatientMessagesScreen />} />
  ...
  return (
    <Routes>
      <Route element={<PatientShell />}>
        ...
        <Route
          path="/messages"
          element={<MessagesScreen patientId={session.patientId} title={profile?.assigned_doctor_name ?? 'Your doctor'} />}
        />
