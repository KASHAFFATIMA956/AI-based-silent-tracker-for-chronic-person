...
export const entryService = {
  submitEntry({
    ...
    // null-omission contract as every field above. Persisted only — see
    // context/api-contracts.md.
    if (systolicBp !== undefined && systolicBp !== null) body.systolic_bp = systolicBp
    if (diastolicBp !== undefined && diastolicBp !== null) body.diastolic_bp = diastolicBp
    if (bloodSugarMgDl !== undefined && bloodSugarMgDl !== null) body.blood_sugar_mg_dl = bloodSugarMgDl
