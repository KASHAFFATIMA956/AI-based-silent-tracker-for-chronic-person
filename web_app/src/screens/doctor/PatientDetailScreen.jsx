  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: 1160 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20, flexWrap: 'wrap', marginTop: 4, marginBottom: 24 }}>
        ...
        <button className="rn-btn rn-btn-secondary" onClick={() => navigate(`/roster/${id}/messages`)}>
          Messages
        </button>
  ...
  return (
    <div style={{ display: 'flex', gap: 14, padding: '10px 0', borderBottom: '1px solid var(--rn-divider)' }}>
      ...
      <div style={{ borderLeft: `2px solid ${color}`, paddingLeft: 12, flex: 1, minWidth: 0 }}>
        ...
        {/* Added 2026-09-07 — optional home-monitoring readings, visible
            to the doctor whenever a patient logged one. Persisted only,
            not yet part of risk_result — see context/api-contracts.md. */}
        {((entry.systolic_bp != null && entry.diastolic_bp != null) || entry.blood_sugar_mg_dl != null) && (
          <div style={{ display: 'flex', gap: 12, marginTop: 2, fontSize: 12, opacity: 0.6 }}>
